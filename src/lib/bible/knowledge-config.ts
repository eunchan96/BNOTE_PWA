...
export type CategorySlug = "figures" | "places" | "culture" | "parables";

const CONFIG: Record<
  CategorySlug,
  { title: string; file: string; categoryOrder: string[]; hasSearch: boolean }
> = {
  figures: {
    title: "인물사전",
...
export function getCategoryHasSearch(slug: CategorySlug): boolean {
  return CONFIG[slug].hasSearch;
}
